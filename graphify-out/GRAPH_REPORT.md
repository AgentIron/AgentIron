...
## Summary
- 766 nodes · 1142 edges · 57 communities (49 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `271330cf`
...
Cohesion: 0.05
Nodes (55): ApprovalBar(), ChatArea(), ContextIndicator(), DirectoryIndicator(), MessageInput(), ModelSwitcher(), ButtonProps, AgentContext (+47 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (38): CodeBlock(), CodeBlockProps, GroupedEntry, groupEntries(), ToolActivityLine(), ToolActivityLineProps, ToolActivitySummary(), ToolActivitySummaryProps (+30 more)
...
Cohesion: 0.08
Nodes (34): DB_KEY_MAP, DEFAULTS, JSON_KEYS, persistSetting(), ProviderAuthStatus, SettingsContext, SettingsContextValue, AuthCapability (+26 more)
...
## Knowledge Gaps
- **313 isolated node(s):** `AgentRequest`, `ImageDataJson`, `McpErrorCategory`, `McpErrorStage`, `McpServerStatusJson` (+308 more)
...
- **Why does `create_agent()` connect `Community 2` to `Community 4`?**
