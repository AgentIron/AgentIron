# Graph Report - AgentIron  (2026-05-11)

## Corpus Check
- 115 files · ~43,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 766 nodes · 1142 edges · 55 communities (50 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d417a88`
...
5. `ADDED Requirements` - 10 edges
6. `toolIcon()` - 10 edges
7. `Decisions` - 9 edges
8. `useMcp()` - 9 edges
9. `parseModelSlug()` - 8 edges
10. `SqliteCredentialStore` - 7 edges
...
Cohesion: 0.06
Nodes (51): McpContext, McpContextValue, McpState, useMcp(), DB_KEY_MAP, DEFAULTS, JSON_KEYS, persistSetting() (+43 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (13): AgentInfo, build_provider(), create_agent(), ChatMessage, auth_status_response(), DeviceCodeStartResponse, get_provider_auth_status(), ProviderAuthStatusResponse (+5 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (26): AcpClient, AttachedImage, plugin_dialog, Diagnostic, SkillItem, activateSkill(), cancelActivePrompt(), compactSession() (+18 more)
...
Cohesion: 0.07
Nodes (29): arc, ApiCost, ApiLimit, ApiModalities, ApiModel, ApiProvider, RegistryModel, hashmap (+21 more)
...
Cohesion: 0.16
Nodes (12): GroupedEntry, groupEntries(), ChatContext, ChatContextValue, ChatState, PendingApproval, store, respondToApproval() (+4 more)
...
## Knowledge Gaps
- **313 isolated node(s):** `Context`, `Goals / Non-Goals`, `Use SQLite for the first OAuth credential store`, `Keep API keys in existing settings for this change`, `code:text (if provider has a non-empty API key:)` (+308 more)
...
- **Why does `App()` connect `Community 10` to `Community 0`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `create_agent()` connect `Community 2` to `Community 5`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `Context`, `Goals / Non-Goals`, `Use SQLite for the first OAuth credential store` to the rest of the system?**
