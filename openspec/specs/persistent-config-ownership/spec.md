...
Define ownership boundaries for persistent AgentIron configuration so shared runtime state lives behind `iron-core` config APIs while desktop/frontend-specific state remains app-owned.
